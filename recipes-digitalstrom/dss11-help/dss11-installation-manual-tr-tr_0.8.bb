...
do_install () {
    install -m 0755 -d ${D}/www/pages/help/tr_TR
    install ${WORKDIR}/index.html ${D}/www/pages/help/tr_TR/index.html
}
#mv ${S}/manual/* ${D}/www/pages/help/tr_TR

FILES_${PN} = "/www/pages/help/tr_TR/*"
